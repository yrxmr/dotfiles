...
exec --no-startup-id ~/menu_script.sh
...
bindsym $mod+m exec --no-startup-id rofi -show drun -config ~/.config/rofi/config.rasi
...
bindsym $mod+f mode "$mode_floating"
